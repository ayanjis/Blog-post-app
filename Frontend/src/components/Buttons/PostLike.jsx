...
import useLikeListener from "../../hooks/useLikeListener";
...
export default function PostLike({ post_ID, iconSize }) {
  ...
  const fetchLikes = async () => {
    ...
    try {
      ...
      setLiked(likes.some((like) => like.user === authorizUser));
    } catch (error) {
  ...
  const handleLikeToggle = async () => {
    ...
    try {
      ...
      if (liked) {
        ...
        toast.success(`You unlike ${postCreatorName}'s post.`);
      } else {
        response = await axios.put(
        ...
        toast.success(`You like ${postCreatorName}'s post.`);
      }
